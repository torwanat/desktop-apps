<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Search.aspx.cs" Inherits="LibraryApp.Search" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            <div class="container">
                <asp:Button CssClass="button" runat="server" Text="Search with OR" ID="btSearch" OnClick="btSearch_Click"></asp:Button>
                <asp:Button CssClass="button" runat="server" Text="Search with AND" ID="btSearchAnd" OnClick="btSearchAnd_Click"></asp:Button>                                
